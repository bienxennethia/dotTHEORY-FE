    ...
    <main>
        <section class="rabbit">
            ...
            <div class="rabbit__content">
                <h1 class="rabbit__title list-title">Netherland Dwarf Rabbit</h1>
                <p>The Netherland Dwarf is a breed of domestic rabbit that originated in the Netherlands. Weighing 1.1–2.5 pounds (0.50–1.13 kg), the Netherland Dwarf is one of the smallest rabbit breeds. Its popularity as a pet or show rabbit may stem from its neotenic appearance. The Netherland Dwarf is recognised by both the American Rabbit Breeders Association (ARBA) and the British Rabbit Council (BRC). The Netherland Dwarf is often confused with the Polish breed of rabbit, but the latter has longer ears, a non-brachycephalic head and less cobbiness.</p>
            </div>
        </section>
